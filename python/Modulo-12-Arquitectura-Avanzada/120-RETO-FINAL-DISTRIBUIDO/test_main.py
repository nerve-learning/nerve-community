...
def test_archivo_existe():
    if "98" not in "120-RETO-FINAL-DISTRIBUIDO" and "99" not in "120-RETO-FINAL-DISTRIBUIDO" and "117" not in "120-RETO-FINAL-DISTRIBUIDO" and "120" not in "120-RETO-FINAL-DISTRIBUIDO":
...
def test_especifico():
    codigo = _codigo()
    assert os.path.exists(os.path.join(BASE, "radar.py")) and os.path.exists(os.path.join(BASE, "filtro.py")) and os.path.exists(os.path.join(BASE, "alarma.py"))
