...
def test_archivo_existe():
    if "98" not in "118-restricciones-rate-limit" and "99" not in "118-restricciones-rate-limit" and "117" not in "118-restricciones-rate-limit" and "120" not in "118-restricciones-rate-limit":
