...
def test_archivo_existe():
    if "98" not in "103-configuracion-externa" and "99" not in "103-configuracion-externa" and "117" not in "103-configuracion-externa" and "120" not in "103-configuracion-externa":
...
def test_especifico():
    codigo = _codigo()
    assert os.path.exists(os.path.join(BASE, "nerve.config"))
