...
def test_archivo_existe():
    if "98" not in "104-cli-bridge" and "99" not in "104-cli-bridge" and "117" not in "104-cli-bridge" and "120" not in "104-cli-bridge":
...
def test_especifico():
    codigo = _codigo()
    assert "procesador_web" in codigo, "Debes conectar tu cliente con el nombre 'procesador_web'"
    assert "listen" in codigo, "Debes poner a escuchar a tu cliente con .listen()"
