...
def test_archivo_existe():
    if "98" not in "99-optimizacion" and "99" not in "99-optimizacion" and "117" not in "99-optimizacion" and "120" not in "99-optimizacion":
...
def test_especifico():
    codigo = _codigo()
    assert os.path.exists(os.path.join(BASE, "sensor.py")) and os.path.exists(os.path.join(BASE, "hub_estricto.py"))
