...
def test_archivo_existe():
    if "98" not in "95-criptografia" and "99" not in "95-criptografia" and "117" not in "95-criptografia" and "120" not in "95-criptografia":
...
def test_especifico():
    codigo = _codigo()
    assert os.path.exists(os.path.join(BASE, "boveda.nrv"))
