...
def test_archivo_existe():
    if "98" not in "98-despliegue" and "99" not in "98-despliegue" and "117" not in "98-despliegue" and "120" not in "98-despliegue":
...
def test_especifico():
    codigo = _codigo()
    assert os.path.exists(os.path.join(BASE, "hub_fortaleza.py")) and os.path.exists(os.path.join(BASE, "cliente_legal.py"))
